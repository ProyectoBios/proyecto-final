...
class PControladorPedidos implements IPPedidos{
    ...
    public OrdenPedido buscarOrdenPedido(int idOrden) throws Exception {
        try(Connection con = Conexion.AbrirConexion();
            ...
            if(resultado.next()){
                orden = new OrdenPedido(resultado.getInt("idOrden"), resultado.getTimestamp("fecha"), resultado.getString("estado"), resultado.getString("descripcionEntrega"), resultado.getTimestamp("ultimaActEst"), resultado.getString("direccionEnvio"), resultado.getString("contacto"), resultado.getDouble("subtotal"), buscarCliente(resultado.getString("nombreCliente")), PControladorEmpleados.getInstancia().buscarEmpleado(resultado.getString("operador"), false), PControladorEmpleados.getInstancia().buscarEmpleado(resultado.getString("funcionario"), false), PControladorEmpleados.getInstancia().buscarRepartidor(resultado.getString("repartidor"), false), buscarLineasXOrden(resultado.getInt("idOrden")));
            }
    ...
    public ArrayList<OrdenPedido> buscarOrdenesXCliente(Cliente cliente) throws Exception {
        try(Connection con = Conexion.AbrirConexion();
            ...
            while(resultado.next()){
                orden = new OrdenPedido(resultado.getInt("idOrden"), resultado.getTimestamp("fecha"), resultado.getString("estado"), resultado.getString("descripcionEntrega"), resultado.getTimestamp("ultimaActEst"), resultado.getString("direccionEnvio"), resultado.getString("contacto"), resultado.getDouble("subtotal"), cliente, PControladorEmpleados.getInstancia().buscarEmpleado(resultado.getString("operador"), false), PControladorEmpleados.getInstancia().buscarEmpleado(resultado.getString("funcionario"), false), PControladorEmpleados.getInstancia().buscarRepartidor(resultado.getString("repartidor"), false),buscarLineasXOrden(resultado.getInt("idOrden")));
                ordenes.add(orden);
            }
